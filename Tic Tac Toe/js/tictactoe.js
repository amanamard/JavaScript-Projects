...
function placeXOrO(squareNumber) {
    ...
    if(!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        // Returning true is needed for our computersTurn() fonction to work
        return true;
    }
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        ...
        x2 = coordX2,
        // This line indicate where the end of a line y axis is
        y2 = coordY2,
    ...
    function animateLineDrawing() {
        ...
        if(x1 <= x2 && y1 <= y2) {
            ...
            if(x < x2) { x += 10;}
            // This condition adds 10 tp the previous end y endpoint
            if(y < y2) { y += 10; }
        ...
        // This condition is similar to the one above
        // this is necessay for the 6, 4, 2 win conditions
        if(x1 <= x2 && y1 >= y2) {
            if(x < x2) { x += 10; }
            if(y > y2) { y -= 10; }
